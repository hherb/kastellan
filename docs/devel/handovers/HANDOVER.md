...
## Recently completed (this session, 2026-05-27 — Issue [#131](https://github.com/hherb/hhagent/issues/131): `bring_up_pg_cluster_with_timeout` sibling for per-call timeout override, branch `feat/issue-131-bring-up-pg-cluster-timeout-override`, PR pending)
