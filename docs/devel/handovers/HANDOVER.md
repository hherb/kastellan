...
**Last updated:** 2026-06-27 (**Firecracker micro-VM SLICE 2 — warm/idle reuse + re-armable watchdog — DONE, both-platform verified, MERGED to `main` as `555f611` (PR [#369](https://github.com/hherb/kastellan/pull/369)).**
