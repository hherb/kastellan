...
## Recently completed (this session, 2026-05-28 — test pin: Issue [#89](https://github.com/hherb/hhagent/issues/89) — `/tmp` per-spawn ephemeral tmpfs invariant, branch `fix/issue-89-tmpfs-per-spawn-invariant-test`, PR pending)
