...
**Last commit on `main`:** `a1dbef6` (post-merge fix `fix(entity_extraction): address PR #125 code-review feedback`, on top of PR #125 merge commit `dac0dcd`). Substantive merges in order: `dac0dcd` (PR [#125](https://github.com/hherb/hhagent/pull/125), Item 28 — Issue #95 entity-upsert Layer B), `e93997e` (PR [#124](https://github.com/hherb/hhagent/pull/124), Item 27 — Slice 2.5 follow-up triple).
...
## Recently completed (this session, 2026-05-26 — Next-TODO Item 29: `HHAGENT_PG_BIN_DIR` env-var override on test-fixture Postgres discovery, branch `feat/pg-bin-dir-env-override`, **PR pending**)
