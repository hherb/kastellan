...
**Last commit on `main`:** `8655319` (PR #133 merge commit `Merge pull request #133 from hherb/feat/issue-131-bring-up-pg-cluster-timeout-override`) carrying 3 branch commits (`8f965ac` doc-sync + `2d4084c` feature + `4edc250` docs claim) plus same-PR post-review nit `876fb42` (sub-second-Duration-aware panic-message formatting). Substantive merges in order: `8655319` (PR [#133](https://github.com/hherb/hhagent/pull/133), Issue #131 — `bring_up_pg_cluster_with_timeout` sibling), `162f71f` (PR [#132](https://github.com/hherb/hhagent/pull/132), test-module lift quadruple), `4e94e42` (PR [#129](https://github.com/hherb/hhagent/pull/129), `bring_up_pg_cluster` polling-cap lift + 5-site consolidation), `bb32cab` (PR [#128](https://github.com/hherb/hhagent/pull/128), Issues #114 + #115 — `walk_*_edges` diamond-dedupe + `walk_edges_around` combined UNION ALL), `7adc582` (PR [#126](https://github.com/hherb/hhagent/pull/126), Item 29 — `HHAGENT_PG_BIN_DIR` env-override), `dac0dcd` (PR [#125](https://github.com/hherb/hhagent/pull/125), Item 28 — Issue #95 entity-upsert Layer B).
...
**Branch `feat/worker-lifecycle-hardening-trio`:** current working branch; closes issues [#84](https://github.com/hherb/hhagent/issues/84) + [#85](https://github.com/hherb/hhagent/issues/85) + [#86](https://github.com/hherb/hhagent/issues/86); PR pending.
...
## Recently completed (this session, 2026-05-27 — worker_lifecycle hardening trio (issues [#84](https://github.com/hherb/hhagent/issues/84) + [#85](https://github.com/hherb/hhagent/issues/85) + [#86](https://github.com/hherb/hhagent/issues/86)), branch `feat/worker-lifecycle-hardening-trio`, PR pending)
