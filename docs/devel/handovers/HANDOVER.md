...
**★ TOP PICK — `browser-driver` Phase 2 (ROADMAP:147)** is the leading egress/Phase-3 pick (see its block below); Phase-2 channels (IMAP/Telegram inbound) are the next phase boundary.
