...
**Last updated:** 2026-05-12 (post-merge of PR #38)
**Last commit (main):** `97f2743` (merge of PR #38 `refactor/tests-common-hoist`; includes one post-merge review-nits fixup `066927e`). **No active working branch — tree clean on `main`.**
