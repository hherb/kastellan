...
## Recently completed (this session, 2026-05-23 — Next-TODO Item 21: `hhagent-cli relations show <entity-id> [--depth N] [--format plain|json]`, branch `feat/relations-show-cli`, PR [#113](https://github.com/hherb/hhagent/pull/113))
