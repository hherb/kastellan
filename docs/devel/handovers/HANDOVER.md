...
## Recently completed (this session, 2026-05-26 — Issues [#114](https://github.com/hherb/hhagent/issues/114) + [#115](https://github.com/hherb/hhagent/issues/115): `walk_*_edges` diamond-dedupe + `walk_edges_around` combined UNION ALL, branch `fix/issues-114-115-walk-edges-dedupe-and-combine`, **PR pending**)
