...
**Currently on (this session):** branch `fix/issue-130-launchd-bringup-serialization` (off `main` at `a83be4a`). #130 + #163 work + the spec + the PR-#162-merged doc reconcile. Not yet pushed/PR'd at the time of this line (see session end). One untracked, unrelated file: `docs/essay-medium-draft.md`.
