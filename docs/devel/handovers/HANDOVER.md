...
**Last updated:** 2026-06-29 (**micro-VM follow-up [#374](https://github.com/hherb/kastellan/issues/374) — forward worker `args` into the guest init — DONE, DGX-verified, branch `feat/374-microvm-forward-worker-args` (off `main`@`a1db0a7`), PR pending.**
