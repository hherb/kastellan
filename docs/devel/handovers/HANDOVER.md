...
**Last commit on `main`:** `fed0f21` (PR #137 merge commit `Merge pull request #137 from hherb/fix/issue-136-pending-acquires-warn-debounce`) carrying 2 branch commits (`8204a3c` doc-sync + `9fae2f9` feature for #136) plus `75514cb` claim-of-work landed on `main` pre-merge. **Current working branch `refactor/idle-timeout-release-sibling-lift`** carries 1 in-progress commit ahead of `main` (the release-path sibling-lift refactor); PR pending. Substantive merges in order: `fed0f21` (PR [#137](https://github.com/hherb/hhagent/pull/137), Issue #136 — debounce pending-acquires queue-depth warn), `7f98ee4` (PR [#135](https://github.com/hherb/hhagent/pull/135), worker_lifecycle hardening trio — closes #84 + #85 + #86), `8655319` (PR [#133](https://github.com/hherb/hhagent/pull/133), Issue #131 — `bring_up_pg_cluster_with_timeout` sibling), `162f71f` (PR [#132](https://github.com/hherb/hhagent/pull/132), test-module lift quadruple), `4e94e42` (PR [#129](https://github.com/hherb/hhagent/pull/129), `bring_up_pg_cluster` polling-cap lift + 5-site consolidation), `bb32cab` (PR [#128](https://github.com/hherb/hhagent/pull/128), Issues #114 + #115 — `walk_*_edges` diamond-dedupe + `walk_edges_around` combined UNION ALL), `7adc582` (PR [#126](https://github.com/hherb/hhagent/pull/126), Item 29 — `HHAGENT_PG_BIN_DIR` env-override), `dac0dcd` (PR [#125](https://github.com/hherb/hhagent/pull/125), Item 28 — Issue #95 entity-upsert Layer B).
...
**Branch `refactor/idle-timeout-release-sibling-lift`:** current working branch; closes the Item 29 operator-picks sub-bullet for the `idle_timeout/release.rs` sibling-lift (the natural follow-up flagged at end of Issue #136); PR pending.
...
## Recently completed (this session, 2026-05-28 — refactor: `idle_timeout/release.rs` sibling-lift, branch `refactor/idle-timeout-release-sibling-lift`, PR pending)
