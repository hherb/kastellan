...
## Recently completed (this session, 2026-05-26 → 2026-05-27 — `bring_up_pg_cluster` polling-cap lift + 5-site consolidation, branch `feat/bring-up-pg-cluster-polling-cap-lift`, **merged to `main` via PR [#129](https://github.com/hherb/hhagent/pull/129) at `4e94e42` on 2026-05-27** + same-PR post-review doc polish `f906d18`)
