...
**Last updated:** 2026-06-27 (**Firecracker micro-VM slice-1 follow-up [#362](https://github.com/hherb/kastellan/issues/362) — per-spawn run-dir cleanup — DONE, both-platform verified, branch `feat/362-firecracker-rundir-cleanup` (off `main`@`0d94b23`), PR pending.**
