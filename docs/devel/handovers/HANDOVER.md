...
`feat/egress-operator-cert-pins`, PR pending.** Completes the slice-#4 host-side "last mile": an operator-configurable
...
1839/0/15 Linux baseline carries forward. **Deferred (to file as an issue):** a real-sandbox pin-enforcement e2e — a
