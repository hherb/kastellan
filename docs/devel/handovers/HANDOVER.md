...
**Last updated:** 2026-06-28 (**Firecracker micro-VM SLICE 3 — host-dir sharing — DONE, DGX-verified, MERGED to `main` as `b12f0dc` (PR [#371](https://github.com/hherb/kastellan/pull/371)).**
