...
**Last commit on `main`:** `919882d` (merge of PR #117, Item 23(a) test-module sibling lifts). Earlier on `main` this session: PR #117 (Item 23(a)) merge at `919882d`, docs sync at `9a2ea91`, PR #116 (Item 22) merge at `1abb061`, PR #113 (relations show CLI) at `9a46e18`. Previous session: PR #109 (relations kinds CLI) at `f234d0c` and PR #110 (entities kinds CLI, stacked) at `a65bb4a`. Two follow-up issues filed against the PR-#110 review: [#111](https://github.com/hherb/hhagent/issues/111) and [#112](https://github.com/hherb/hhagent/issues/112) — **both closed by PR #116**.
