...
## Recently completed (this session, 2026-05-28 — refactor: `idle_timeout/release.rs` sibling-lift, branch `refactor/idle-timeout-release-sibling-lift`, **merged to `main` via PR [#138](https://github.com/hherb/hhagent/pull/138) at `5fc5fee`** + in-PR polish `78305cf`)
