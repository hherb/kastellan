...
**Last commit on `feat/entities-kinds-cli`:** TBD after this commit batch. Branch stacks on `feat/relations-kinds-cli` (uses `connect_admin_pool` introduced there); rebases trivially onto main after PR #16-equivalent merges.
