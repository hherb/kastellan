...
**Last commit on `spike/issue-55-macos-container-discovery`:** pending (`docs(handover)` header sync committed at `5481bd8`; about to commit the spike notes + this HANDOVER entry).
