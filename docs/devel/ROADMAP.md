...
- [x] **The planner reads a tool result as labelled JSON** — [#702](https://github.com/hherb/kastellan/pull/702), part of [#677](https://github.com/hherb/kastellan/issues/677) — 2026-09-14. `inner_loop/result_view` replaces the injection guard's key-stripping flattening as the planner's view; identifier keys only, space-free ids never cut. Live: the working question still works; #677's follow-up still fails on [#701](https://github.com/hherb/kastellan/issues/701).
